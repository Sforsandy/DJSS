...
<head>
		...
		<!-- Vendor CSS -->
		{{ Html::style('app-assets/vendor/bootstrap/css/bootstrap.css') }}
		{{ Html::style('app-assets/vendor/animate/animate.css') }}

		{{ Html::style('app-assets/vendor/font-awesome/css/all.min.css') }}
		{{ Html::style('app-assets/vendor/magnific-popup/magnific-popup.css') }}
		{{ Html::style('app-assets/vendor/bootstrap-datepicker/css/bootstrap-datepicker3.css') }}

		<!-- Specific Page Vendor CSS -->		
		{{ Html::style('app-assets/vendor/jquery-ui/jquery-ui.css') }}		
		{{ Html::style('app-assets/vendor/jquery-ui/jquery-ui.theme.css') }}		
		{{ Html::style('app-assets/vendor/bootstrap-multiselect/css/bootstrap-multiselect.css') }}		
		{{ Html::style('app-assets/vendor/morris/morris.css') }}

		<!-- Theme CSS -->
		{{ Html::style('app-assets/css/theme.css') }}

		<!-- Theme Custom CSS -->
		{{ Html::style('app-assets/css/custom.css') }}
		...
		{{ Html::script('app-assets/vendor/modernizr/modernizr.js') }}		
		{{ Html::script('app-assets/master/style-switcher/style.switcher.localstorage.js') }}
	...
	<body>
		<section class="body">
			...
			<header class="header">
				<div class="logo-container">
					<a href="https://preview.oklerthemes.com/porto-admin/2.2.0" class="logo">						
					<img src="{{ url('/') }}/app-assets/img/logo.png" width="75" height="35" alt="Porto Admin" />					
				</a>					
									...
									<ul>
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ url('/') }}/app-assets/img/%21sample-user.jpg" alt="Joseph Doe Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ url('/') }}/app-assets/img/%21sample-user.jpg" alt="Joseph Junior" class="rounded-circle" />
												</figure>
										...
										<li>
											<a href="#" class="clearfix">
												<figure class="image">
													<img src="{{ url('/') }}/app-assets/img/%21sample-user.jpg" alt="Joe Junior" class="rounded-circle" />
												</figure>
					...
					<div id="userbox" class="userbox">
						<a href="#" data-toggle="dropdown">
							<figure class="profile-picture">
								<img src="{{ url('/') }}/app-assets/img/%21logged-user.jpg" alt="Joseph Doe" class="rounded-circle" data-lock-picture="img/%21logged-user.jpg" />
							</figure>
										...
										<header class="card-header bg-primary">
											...
											<div class="widget-profile-info">
												<div class="profile-picture">
													<img src="{{ url('/') }}/app-assets/img/%21logged-user.jpg">
												</div>
													...
													<div class="tm-box">
														...
														<div class="thumbnail-gallery">
															<a class="img-thumbnail lightbox" href="img/projects/project-4.jpg" data-plugin-options='{ "type":"image" }'>
																<img class="img-fluid" width="215" src="{{ url('/') }}/app-assets/img/projects/project-4.jpg">
																<span class="zoom">
							...
							<div class="sidebar-widget widget-friends">
								...
								<ul>
									<li class="status-online">
										<figure class="profile-picture">
											<img src="{{ url('/') }}/app-assets/img/%21sample-user.jpg" alt="Joseph Doe" class="rounded-circle">
										</figure>
										<div class="profile-info">
		...
		<!-- Vendor -->
		{{ Html::script('app-assets/vendor/jquery/jquery.js') }}		
		{{ Html::script('app-assets/vendor/jquery-browser-mobile/jquery.browser.mobile.js') }}		
		{{ Html::script('app-assets/vendor/jquery-cookie/jquery.cookie.js') }}		
		{{ Html::script('app-assets/master/style-switcher/style.switcher.js') }}		
		{{ Html::script('app-assets/vendor/popper/umd/popper.min.js') }}		
		{{ Html::script('app-assets/vendor/bootstrap/js/bootstrap.js') }}		
		{{ Html::script('app-assets/vendor/bootstrap-datepicker/js/bootstrap-datepicker.js') }}		
		{{ Html::script('app-assets/vendor/common/common.js') }}		
		{{ Html::script('app-assets/vendor/nanoscroller/nanoscroller.js') }}		
		{{ Html::script('app-assets/vendor/magnific-popup/jquery.magnific-popup.js') }}		
		{{ Html::script('app-assets/vendor/jquery-placeholder/jquery.placeholder.js') }}
		
		<!-- Specific Page Vendor -->		
		{{ Html::script('app-assets/vendor/jquery-ui/jquery-ui.js') }}
		{{ Html::script('app-assets/vendor/jqueryui-touch-punch/jquery.ui.touch-punch.js') }}
		{{ Html::script('app-assets/vendor/jquery-appear/jquery.appear.js') }}
		{{ Html::script('app-assets/vendor/bootstrap-multiselect/js/bootstrap-multiselect.js') }}
		{{ Html::script('app-assets/vendor/jquery.easy-pie-chart/jquery.easypiechart.js') }}
		{{ Html::script('app-assets/vendor/flot/jquery.flot.js') }}
		{{ Html::script('app-assets/vendor/flot.tooltip/jquery.flot.tooltip.js') }}
		{{ Html::script('app-assets/vendor/flot/jquery.flot.pie.js') }}
		{{ Html::script('app-assets/vendor/flot/jquery.flot.categories.js') }}
		{{ Html::script('app-assets/vendor/flot/jquery.flot.resize.js') }}
		{{ Html::script('app-assets/vendor/jquery-sparkline/jquery.sparkline.js') }}
		{{ Html::script('app-assets/vendor/raphael/raphael.js') }}
		{{ Html::script('app-assets/vendor/morris/morris.js') }}
		{{ Html::script('app-assets/vendor/gauge/gauge.js') }}
		{{ Html::script('app-assets/vendor/snap.svg/snap.svg.js') }}
		{{ Html::script('app-assets/vendor/liquid-meter/liquid.meter.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/jquery.vmap.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/data/jquery.vmap.sampledata.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/maps/jquery.vmap.world.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/maps/continents/jquery.vmap.africa.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/maps/continents/jquery.vmap.asia.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/maps/continents/jquery.vmap.australia.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/maps/continents/jquery.vmap.europe.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/maps/continents/jquery.vmap.north-america.js') }}
		{{ Html::script('app-assets/vendor/jqvmap/maps/continents/jquery.vmap.south-america.js') }}
		
		<!-- Theme Base, Components and Settings -->
		{{ Html::script('app-assets/js/theme.js') }}
		
		<!-- Theme Custom -->
		{{ Html::script('app-assets/js/custom.js') }}
		
		<!-- Theme Initialization Files -->
		{{ Html::script('app-assets/js/theme.init.js') }}
		
		<!-- Examples -->
		{{ Html::script('app-assets/js/examples/examples.dashboard.js') }}
	</body>
</html>