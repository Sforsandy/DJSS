          ...
          <form role="form" id="GameForm" method="post">
            ...
            <div class="box-body">
              <div class="form-group">
                ...
                <input type="text" class="form-control" id="game_name"  value="{{ $data->game_name }}" name="game_name" placeholder="Enter name" maxlength="100">
              </div>
              <a target='_blank' href='{{ url("public/uploads/games")."/".$data->game_image }}' class='purple'>{{ $data->game_image }}</a>
                <div class="form-group">
                ...
                <a target='_blank' href='{{ url("public/uploads/games")."/".$data->game_banner }}' class='purple'>{{ $data->game_banner }}</a>
                <div class="form-group">
