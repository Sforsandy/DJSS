<?php
$PAYTM_MERCHANT_KEY = env('PAYTM_MERCHANT_KEY_TEST');
$PAYTM_MERCHANT_MID = env('PAYTM_MERCHANT_MID_TEST');
$PAYTM_MERCHANT_WEBSITE = env('PAYTM_MERCHANT_WEBSITE_TEST');
$PAYTM_STATUS_QUERY_NEW_URL = env('PAYTM_STATUS_QUERY_NEW_URL_TEST');
$PAYTM_TXN_URL = env('PAYTM_TXN_URL_TEST');
if(env('PAYTM_ENVIRONMENT') == 'PROD')
{
...
return [
    ...
    */
    ...
    'name' => env('APP_NAME', 'GamerzByte'),

    'PAYTM_ENVIRONMENT' => env('PAYTM_ENVIRONMENT', 'PROD'),
    ...
    */
    ...
    'url' => env('APP_URL', 'http://localhost/EsportsEventsManagement/gamerzbyte-web/'),
